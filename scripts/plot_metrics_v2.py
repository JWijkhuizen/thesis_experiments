...
# 		for system in ['b']:
# 			axes.scatter(safety_av[system][scenario][run],timetc[system][scenario][run],color='blue')
# 	for config in configs_sa:
# 		for system in ['sa_m0','sa_m1']:
# 			axes.scatter(safety_av[system][scenario][run],timetc[system][scenario][run],color='red')
...
if scatter_safety_vs_performance:
	for scenario in ['S1','S2','S3']:
		for run in [0]:
			fig, axes = plt.subplots()
			for system in systems:
				axes.scatter(safety_av[system][scenario][run],performance_av[system][scenario][run],color=color_system[system],label=label_system[system])
	...
	for scenario in scenarios:
		...
		for config in configs_sa:
			...
			for system in ['b','sa_m0','sa_m1','sa_m2']:
				values1.append(safety_av[system][scenario][run])
				values2.append(performance_av[system][scenario][run])
